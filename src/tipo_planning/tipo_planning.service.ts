...
export class TipoPlanningService {
  ...
  constructor(
   ...
   async create(createTipoPlanningDto: CreateTipoPlanningDto) {
    ...
    const tipoDePlanning= this.tipoPlanningRepository.create(createTipoPlanningDto)
  ...
  private validarDistribucion(distribucion:number[]){
    ...
    if (suma!=14){
      throw new BadRequestException('La suma de la distribución debe ser igual a 14');
